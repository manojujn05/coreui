...
<div class="card">
    ...
    <form action="{{route('packages_update')}}" method="post">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="package" type="text" value="{{$theater->name}}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="price" type="text" value="{{$theater->price}}" required>
            ...
            <div class="form-actions">
                ...
                <a class="btn btn-success" href="{{ url('packages') }}">Packages list</a>
